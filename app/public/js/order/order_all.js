...
function customCommand(command, aData, tr, divEditDlg) {
	if ((command.length > 4) && (command.substr(0, 4).toLowerCase() == 'pdf_')) {
		var _type_id = ('type_id' in aData) ? parseInt(aData['type_id']) : -1;
		var _order_rowid = ('order_rowid' in aData) ? parseInt(aData['order_rowid']) : -1;
		if ((_type_id < 0) || (_order_rowid < 0)) return '';
		...
		if (_isInt(_strnum)) {
			...
			switch (_type_id) {
				case 1:
					_controller = 'order_polo';
					break;
				case 2:
					_controller = 'order_tshirt';
					break;
				case 3:
					_controller = 'order_premade_polo';
					break;
				case 4:
					_controller = 'order_premade_tshirt';
					break;
				case 5:
					_controller = 'order_cap';
					break;
				case 6:
					_controller = 'order_jacket';
					break;
				case 7:
					_controller = 'order_premade_cap';
					break;
				case 8:
					_controller = 'order_premade_jacket';
					break;
			}
			if (_controller != '') window.open("./" + _controller + "/get_pdf/" + _int + '/' + _order_rowid);
		}
		...
		var _rowid = ('rowid' in aData) ? aData['rowid'] : false;
		if (! _rowid) {
...
function __doChangeProcessStatus(rowid, ps_rowid, strStatusRemark) {
	...
	var _json = {"rowid": _rowid, "ps_rowid": _ps_rowid};
...
function fnc__DDT_Row_RenderPDF(data, type, full) {
	...
	switch (_type_id) {
		case 1:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="F-P001: ใบสั่งซื้อเสื้อสั่งตัดโปโล" />';
			/*
			_strReturn += '<img class="tblButton" command="pdf_2" src="./public/images/pdf_icon_40.png" title="F-P002: ใบสั่งตัดเสื้อโปโล" />';
			_strReturn += '<img class="tblButton" command="pdf_3" src="./public/images/pdf_icon_40.png" title="F-P003: ใบจ่ายงานเย็บเสื้อโปโล" />';
			_strReturn += '<img class="tblButton" command="pdf_4" src="./public/images/pdf_icon_40.png" title="F-P004: ใบจ่ายงานเย็บแขนเสื้อโปโล" />';
			_strReturn += '<img class="tblButton" command="pdf_5" src="./public/images/pdf_icon_40.png" title="F-P005: ใบจ่ายเย็บเสื้อโปโล" />';
			*/
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="F-P006: ใบงานข้อมูล เสื้อโปโล" />';
			break;
		case 2:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="F-T001: ใบสั่งซื้อเสื้อยืดสั่งตัด" />';
			/*
			_strReturn += '<img class="tblButton" command="pdf_2" src="./public/images/pdf_icon_40.png" title="F-T002: ใบสั่งตัดเสื้อยืด" />';
			_strReturn += '<img class="tblButton" command="pdf_3" src="./public/images/pdf_icon_40.png" title="F-T003: ใบจ่ายงานเย็บเสื้อยืด" />';
			*/
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="F-T006: ใบงานข้อมูล เสื้อยืด" />';
			break;
		case 3:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="ใบสั่งซื้อเสื้อโปโลสำเร็จรูป" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล เสื้อโปโลสำเร็จรูป" />';
			break;
		case 4:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="ใบสั่งซื้อเสื้อยืดสำเร็จรูป" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล เสื้อยืดสำเร็จรูป" />';
			break;
		case 5:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="ใบสั่งซื้อหมวกสั่งตัด" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล หมวกสั่งตัด" />';
			break;
		case 6:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="ใบสั่งซื้อแจ็คเก็ตสั่งตัด" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล แจ็คเก็ตสั่งตัด" />';
			break;
		case 7:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="สั่งซื้อหมวกสำเร็จรูป" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล หมวกสำเร็จรูป" />';
			break;
		case 8:
			_strReturn += '<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="สั่งซื้อแจ็คเก็ตสำเร็จรูป" />';
			_strReturn += '<img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="ใบงานข้อมูล แจ็คเก็ตสำเร็จรูป" />';
			break;
	}
	return _strReturn;	
}

function fnc__DDT_Row_RenderView(data, type, full) {
	var _type_id = ('type_id' in full) ? parseInt(full['type_id']) : -1;
	var _order_rowid = ('order_rowid' in full) ? parseInt(full['order_rowid']) : -1;
	if ((_type_id < 0) || (_order_rowid < 0)) return '';
	...
	_elPanel.append($('<img class="list-row-button" command="link" src="./public/images/b_view.png" alt="view" title="' + MSG_ICON_TITLE_VIEW + '">'));
...
function fnc__DDT_Row_RenderEdit(data, type, full) {
	...
	switch (_type_id) {
		case 1:
			_href = 'order_polo/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 2:
			_href = 'order_tshirt/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 3:
			_href = 'order_premade_polo/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 4:
			_href = 'order_premade_tshirt/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 5:
			_href = 'order_cap/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 6:
			_href = 'order_jacket/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 7:
			_href = 'order_premade_cap/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
		case 8:
			_href = 'order_premade_jacket/pass_command/2/' + _order_rowid + '/' + _order_job_number;
			break;
	}
	_elPanel.append($('<img class="list-row-button" command="link" src="./public/images/b_edit.png" alt="edit" title="' + MSG_ICON_TITLE_EDIT + '">'));
	return _elPanel.html();
}
