...
class Master_flap_side_ptrn extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_flap_side_ptrn';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "รูปแบบ", array(), array("selectable"=>TRUE, "width"=>"300px", "class"=>"center", "default"=>TRUE,"order"=>0));
		...
		$pass['title'] = "รูปแบบชายเสื้อด้านข้าง";
