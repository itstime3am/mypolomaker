...
class Master_pocket_type extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_pocket_type';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "แบบกระเป๋า", NULL, array("selectable"=>TRUE, "width"=>"300px", "class"=>"center", "default"=>TRUE,"order"=>0));		
		...
		$pass['title'] = "ประเภทกระเป๋าหน้าอก";
