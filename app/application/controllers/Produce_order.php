...
class Produce_order extends MY_Ctrl_order {
	function __construct() {
		parent::__construct();
		$this->modelName = 'Mdl_produce_order';
	...
	public function index($customer_rowid = -1) {
		...
		if ($this->_blnCheckRight('export_pdf')) $_custom_columns[] = array(
				"column" => '{"sTitle":"เอกสาร", "sClass": "center","mData": function() { return \'<img class="tblButton" command="pdf_1" src="./public/images/pdf_icon_40.png" title="F-P001 : ใบสั่งซื้อเสื้อสั่งตัดโปโล" /><img class="tblButton" command="pdf_2" src="./public/images/pdf_icon_40.png" title="F-P002 : ใบสั่งตัดเสื้อโปโล" /><img class="tblButton" command="pdf_3" src="./public/images/pdf_icon_40.png" title="F-P003 : ใบจ่ายงานเย็บเสื้อโปโล" /><img class="tblButton" command="pdf_4" src="./public/images/pdf_icon_40.png" title="F-P004 : ใบจ่ายงานเย็บแขนเสื้อโปโล" /><img class="tblButton" command="pdf_5" src="./public/images/pdf_icon_40.png" title="F-P005 : ใบจ่ายเย็บเสื้อโปโล" /><img class="tblButton" command="pdf_6" src="./public/images/pdf_icon_40.png" title="F-P006 : ใบงานข้อมูล เสื้อโปโล" />\';}, "bSortable": false}'
				, "order" => 15
			);
