...
class Master_neck_type extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_neck_type';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "แบบคอเสื้อ", array(), array("selectable"=>TRUE, "width"=>"300px", "class"=>"center", "default"=>TRUE,"order"=>0));
