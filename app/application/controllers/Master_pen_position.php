...
class Master_pen_position extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_pen_position';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "ตำแหน่ง", NULL, array("selectable"=>TRUE, "width"=>"300px", "class"=>"center", "default"=>TRUE,"order"=>0));		
		...
		$pass['title'] = "ตำแหน่งที่เสียบปากกา";
