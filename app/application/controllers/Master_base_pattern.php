...
class Master_base_pattern extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_base_pattern';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "ชื่อ", array(), array("selectable"=>TRUE,"width"=>"300px", "class"=>"center","default"=>TRUE,"order"=>0));
