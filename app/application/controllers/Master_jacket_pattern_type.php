...
class Master_jacket_pattern_type extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_jacket_pattern_type';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "รูปแบบ", NULL, array("selectable"=>TRUE,"width"=>"300px", "class"=>"center", "default"=>TRUE,"order"=>0));
