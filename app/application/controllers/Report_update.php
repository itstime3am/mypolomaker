...
class Report_update extends MY_Ctrl_crud {
	...
	public function index($product_type_id = 0) {
		...
		$this->add_js(
			array(
				...
				'public/js/report/report_update.js',
		...
		$this->_setController("order_status", "สถานะ", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"center edit order_status_id","width"=>'80px',"order"=>0));
		$this->_setController("job_number", "เลขที่ใบสั่งตัด", array(), array("selectable"=>TRUE,"default"=>TRUE,"order"=>1));
		$this->_setController("order_date", "วันที่", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"center","order"=>2));
		...
		if ($this->_PRODUCT_TYPE_ID == 5) {
			...
			$this->_setController("detail2", "", array(), array("selectable"=>TRUE,"default"=>TRUE,"order"=>11));

			$this->_setController("ปักโรงงาน", "ปักโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>21));
			$this->_setController("ปักร้านหมวก", "ปักร้านหมวก", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>22));
			$this->_setController("สกรีนโรงงาน", "สกรีนโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>25));
			$this->_setController("สกรีนร้านหมวก", "สกรีนร้านหมวก", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>26));
		} else if ($this->_PRODUCT_TYPE_ID == 6) {
			$this->_setController("detail1", "", array(), array("selectable"=>TRUE,"default"=>TRUE,"order"=>8));
			$this->_setController("detail2", "", array(), array("selectable"=>TRUE,"order"=>9));
			$this->_setController("detail3", "", array(), array("selectable"=>TRUE,"default"=>TRUE,"order"=>10));

			$this->_setController("ปักโรงงาน", "ปักโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>21));
			$this->_setController("ปักร้านแจ็คเก็ต", "ปักร้านแจ็คเก็ต", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>22));
			$this->_setController("สกรีนโรงงาน", "สกรีนโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>23));
			$this->_setController("สกรีนร้านแจ็คเก็ต", "สกรีนร้านแจ็คเก็ต", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class default_number"=>"right","order"=>24));
			$this->_setController("สกรีนปุ้ย", "สกรีนปุ้ย", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>25));
			$this->_setController("สกรีนพี่นี", "สกรีนพี่นี", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>26));
		} else {
			...
			$this->_setController("ปักโรงงาน", "ปักโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>21));
			$this->_setController("ปักพี่แดง", "ปักพี่แดง", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>22));
			$this->_setController("ปักร็อค", "ปักร็อค", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>23));
			$this->_setController("สกรีนโรงงาน", "สกรีนโรงงาน", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>24));
			$this->_setController("สกรีน DTG", "สกรีน DTG", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>25));
			$this->_setController("สกรีนปุ้ย", "สกรีนปุ้ย", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>26));
			$this->_setController("สกรีนพี่นี", "สกรีนพี่นี", array(), array("selectable"=>TRUE,"width"=>"80","default"=>TRUE,"class"=>"right default_number","order"=>27));
		}
		...
		$this->_setController("due_date", "กำหนดส่ง", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"center","order"=>18));
		$this->_setController("deliver_date", "วันที่ส่งลูกค้า", array(), array("selectable"=>TRUE,"width"=>"90","default"=>TRUE,"class"=>"center","order"=>19));
		$this->_setController("sum_qty", "จำนวนตัว", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"right default_int","order"=>20));
		$this->_setController("ea_item_price", "ราคาเสื้อเฉลี่ย", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"default_number","order"=>30));
		$this->_setController("ea_screen_price", "ราคาสกรีนเฉลี่ย", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"default_number","order"=>31));
		$this->_setController("ea_weave_price", "ราคาปักเฉลี่ย", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"default_number","order"=>32));
		$this->_setController("ea_other_price", "ราคาอื่นๆเฉลี่ย", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"80","class"=>"default_number","order"=>33));
		$this->_setController("total_price_each", "ราคารวมเฉลี่ย", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"90","class"=>"default_number","order"=>34));
		$this->_setController("total_price_sum_net", "ราคารวม", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"90","class"=>"default_number","order"=>35));
		$this->_setController("total_price_sum_vat", "VAT", array(), array("selectable"=>TRUE,"default"=>TRUE,"width"=>"60","class"=>"default_number","order"=>36));
		$this->_setController("total_price_sum", "รวมทั้งสิ้น", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"default_number","order"=>37));
		$this->_setController("deposit_payment", "จำนวนเงินมัดจำ", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"default_number edit deposit_payment","order"=>38));
		$this->_setController("deposit_route", "ช่องทางการชำระมัดจำ", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"center edit deposit_route_id","order"=>39));
		$this->_setController("deposit_date", "วันที่ชำระมัดจำ", array(), array("selectable"=>TRUE,"default"=>TRUE,"class"=>"center edit deposit_date","order"=>40));
		//-- set special attributes
		...
		$pass['title'] = "รายงานปรับปรุงสถานะ";
	...
	function strGetTableTemplate() {
		//if (($this->_PRODUCT_TYPE_ID == 5) || ($this->_PRODUCT_TYPE_ID == 6))
		$_str1 = '';
		$_strD1 = '';
		$_arrD1 = array();
		$_arrDW = array();
...
<table id="tblSearchResult" class="cls-tbl-list">
	<thead>
		<tr>
			...
			<th colspan="{$_strCS1}" class="ui-state-default">$_strD1</th>
			<th colspan="2" class="ui-state-default">สกรีน</th>
			<th colspan="2" class="ui-state-default">ปัก</th>
		...
		<tr>
TBL;
			$_tmpl .= '<th>' . join('</th><th>', $_arrD1) . '</th>';
/*
			<th>แบบคอ</th><th>แบบทรง</th><th>แบบเสื้อ</th><th>สีหลัก</th><th>สีตัดต่อ</th>
*/
...
/*
			<th>ปักโรงงาน</th><th>ปักพี่แดง</th><th>ปักร็อค</th>
			<th>สกรีน DTG</th><th>สกรีนปุ้ย</th><th>สกรีนพี่นี</th>
*/
			$_tmpl .= <<<TBL
