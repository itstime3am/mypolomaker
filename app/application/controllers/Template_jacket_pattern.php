...
class Template_jacket_pattern extends MY_Ctrl_crud {
	...
	public function index() {
		...
		$this->_setController('lining_type_rowid', ''); //- new 
		$this->_setController('lining_type_detail', '', array('type'=>'txa', 'rows'=>1, 'maxlength'=>140)); //- new
		...
		$this->_setController('clasper_ptrn_rowid', 'รูปแบบสาบกระดุม');
		$this->_setController('clasper_detail', '', array('type'=>'txa', 'rows'=>1, 'maxlength'=>30));
		...
		$this->_setController('pocket_position_rowid', 'ตำแหน่งกระเป๋า');
		$this->_setController('pocket_position_detail', '', array('type'=>'txa', 'rows'=>1, 'maxlength'=>60));
		$this->_setController('pocket_type_rowid', 'ทรงกระเป๋า');
		...
		$this->_setController('option_hem_color_rowid', 'สีกุ๊น', array('type'=>'sel', 'sel_options'=>$this->_selOptions['option_hem_color'])); //- new 
			...
			array(
				'controls' => array(
					...
					array(
						"type" => "sel",
						"label" => "แบบเสื้อ",
						"name" => "standard_pattern_rowid",
						"sel_options" => $this->_selOptions['standard_pattern'],
						"sel_val" => "rowid",
						"sel_text" => "name"
					)
				)
		...
		$pass['title'] = "แบบเสื้อแจ๊คเก็ตสำเร็จรูป";
