...
class Master_lining_type extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_lining_type';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "แบบปก / คอเสื้อ", array(), array("selectable"=>TRUE,"default"=>TRUE,"order"=>0));
/*
