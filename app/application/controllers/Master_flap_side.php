...
class Master_flap_side extends MY_Ctrl_crud {
	function __construct() 
	{
		parent::__construct();
		$this->modelName = 'Mdl_flap_side';
	}
	...
	public function index()
	{
		...
		$this->_setController("name", "แบบชายเสื้อข้าง", array(), array("selectable"=>TRUE,"width"=>"300px", "class"=>"center","default"=>TRUE,"order"=>0));
		...
		$pass['title'] = "ประเภทชายเสื้อด้านข้าง";
