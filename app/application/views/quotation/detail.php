								...
								<div class="frm-edit-row" style="display:inline-block;" >
									<div role="img" aria-label="" class="frm-edit-row-value div-disp-img-upload display-upload disp-upload-main" id="div_fmg_file_image1" >
										...
										<span class="spn-image-select eventView-hide">
											...
											<input type="file" id="fmg-file_image1" name="image" class="user-input data-container input-file-upload" data="file_image1">
										</span>
										<input type="hidden" id="hdn-file_image1" class="user-input fmg-value no-commit" />
									</div>
								</div>
<?php $_currIndex = 1; ?>
...
<?php		$_id = $_currIndex + (($_r * 4) + $_c); ?>
									<div role="img" aria-label="" class="frm-edit-row-value div-disp-img-upload display-upload disp-upload-sub" id="div_fmg_file_image<?php echo $_id; ?>" >
										...
										<span class="spn-image-select eventView-hide">
											...
											<input type="file" id="fmg-file_image<?php echo $_id; ?>" name="image" class="user-input data-container input-file-upload" data="file_image<?php echo $_id; ?>">
										</span>
										<input type="hidden" id="hdn-file_image<?php echo $_id; ?>" class="user-input fmg-value no-commit" />
									</div>
<?php 	endfor; ?>
								</div>
<?php endfor; ?>
