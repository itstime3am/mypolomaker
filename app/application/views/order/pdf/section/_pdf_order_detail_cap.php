			...
			<div class="pdf-row">
				...
				<div style="margin-left:1cm;">
					<div class="pdf-title w-2_7">หลัก (หน้าหมวก)</div><div class="pdf-value w-3"><?php echo $data['front_color']; ?></div>
					<div class="pdf-title w-2_4">รอง (หลังหมวก)</div><div class="pdf-value w-3"><?php echo $data['back_color']; ?></div>
					<div class="pdf-title w-1_6">ปีกหมวก</div><div class="pdf-value w-all"><?php echo $data['brim_color']; ?></div>
				</div>
			</div>
			<div class="pdf-row">
