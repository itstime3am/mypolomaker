...
?>
			...
			<div class="pdf-row screen-row">
				...
				<div class="screen-header screen-title w-2">ขนาดงาน</div>
			<?php if ($_blnDispPrice): ?>
				<div class="screen-header screen-title w-4">ประวัติ</div>
	...
	<?php if (is_array($arrScreen)) : ?>
		<?php for($i=0;$i<count($arrScreen);$i++): ?>
			...
			<div class="pdf-row screen-row">
				...
				<div class="screen-item w-2"><?php echo $_ea['size']; ?></div>
			<?php if ($_blnDispPrice): ?>
				<div class="screen-item w-4"><?php echo $_ea['job_hist']; ?></div>
