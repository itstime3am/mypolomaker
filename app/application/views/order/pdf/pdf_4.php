...
.pdf-checkbox {margin-left:0.2cm;margin-right:0px;width:0.6cm;vertical-align:text-bottom;}
.pdf-checkbox img {vertical-align:text-bottom;}

.pdf-tag-block {display:flex;border:1px solid black;}
.pdf-tag-left {border-right:1px solid black;display:block;float:left;width:3cm;padding-bottom:0.3cm;overflow:hidden;}
...
.pdf-tag-row div {display:block;float:left;vertical-align:middle;height:0.6cm;line-height:0.6cm;}
		</style>
	</head>
	<body>
		<div class="page">
...
<?php
	$_currTime = date('d/m/Y h:i:sa');
	$_strMale = 'public/images/checkbox_no.png';
	$_strFemale = 'public/images/checkbox_no.png';
	if (isset($data['m_pen'])) $_strMale = ($data['m_pen'] == 1)?'public/images/checkbox_yes.png':'public/images/checkbox_no.png'; 
	if (isset($data['f_pen'])) $_strFemale = ($data['f_pen'] == 1)?'public/images/checkbox_yes.png':'public/images/checkbox_no.png'; 
?>
	<?php for($i=0;$i<5;$i++) : ?>
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border">ชื่อช่างเย็บแขน</div>
				...
				<div class="pdf-tag-detail">
					<div class="pdf-tag-row">
						<div class="pdf-title w-2_5">ที่เสียบปากกา</div>
						<div class="w-1_5"></div>
						<div class="pdf-checkbox"><img src="<?php echo $_strMale; ?>"></div><div class="pdf-label w-2" style="margin-left:0;">เสื้อผู้ชาย</div>
						<div class="w-1_5"></div>
						<div class="pdf-checkbox"><img src="<?php echo $_strFemale; ?>"></div><div class="pdf-label w-2" style="margin-left:0;">เสื้อผู้หญิง</div>
					</div>
					<div class="pdf-tag-row">
						<div class="pdf-title w-2_5">ชื่อลูกค้า</div><div class="pdf-value w-5"><?php echo $data['customer_name']; ?></div>
						<div class="pdf-title w-2_5">เลขที่ขาย</div><div class="pdf-value w-2_5"><?php echo $data['job_number']; ?></div>
					</div>
					<div class="pdf-tag-row">
						<div class="pdf-title w-2_5">จำนวน</div><div class="pdf-user-input w-2"></div><div class="pdf-title w-0_6">(ตัว)</div>
						<div class="pdf-title w-2">ราคาต่อหน่วย</div><div class="pdf-user-input w-2_5"></div>
						<div class="pdf-title w-2">รวมเป็นเงิน</div><div class="pdf-user-input w-all"></div>
					</div>
				</div>
			</div>
			<div class="pdf-row">
