...
<?php if (!isset($type_premade_order)): ?>
			<li><a href="#tab_order_detail">รายละเอียดแบบ</a></li>
			<li><a href="#tab_order_other">ขนาด จำนวน งานปัก/สกรีน</a></li>
<?php else: ?>
...
<?php endif; ?>
								...
								<div class="frm-edit-row" >
									...
									<div class="frm-edit-row-value cls-customer-detail" style="width:45%" >
										<input type="text" id="txt-company" class="user-input data-container set-disabled no-commit" style="width:98%;" readonly="readonly" data="company"/>
									</div>
...
<?php endif; ?>
		...
		<div id="tab_order_detail">
			<div id="ord_dtl_container" class="form-edit-elem-container">
				<?php echo isset($detail_panel)?$detail_panel:''; ?>
			</div>
		</div>
<?php if (! isset($type_premade_order)): ?>
		<div id="tab_order_other">
			<div id="ord_other_container" class="form-edit-elem-container">
				<?php echo isset($others_panel)?$others_panel:''; ?>
			</div>
		</div>
<?php endif; ?>
