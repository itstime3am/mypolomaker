...
<div id="tabs" style="display:none;">
	...
	<ul>
		...
		<li><a href="#tab_order_detail">รายละเอียด</a></li>
		<!--li><a href="#tab_others_detail">เพิ่มเติม</a></li-->
...
<?php	foreach ($job_number_list as $row): ?>
										<option value="<?php echo $row['job_number']; ?>" rowid="<?php echo $row['rowid']; ?>">
...
<?php
	if ( ! isset($type_premade_order)) {
		echo <<<EOT
								...
								<div class="frm-edit-row-value" style="width:20%;" >
									<select id="sel-pattern_rowid" class="user-input" >
EOT;
						...
						<div class="frm-edit-row-group" >
							<div class="frm-edit-row" >
								...
								<div class="frm-edit-row-value" >
									<input type="text" id="txt-order_qty" class="user-input input-integer input-required" />
								</div>
							</div>
							<div class="frm-edit-row" >
								<div class="frm-edit-row-title table-title" style="width:20%">ราคาเฉพาะหมวก ( บาท )</div>
								<div class="frm-edit-row-value" >
									<input type="text" id="txt-order_price_each" class="user-input input-double input-required" />
								</div>
							</div>
						</div>
					</div>
...
<script language="javascript">
	...
	$(function() {
		$('#frm_edit #sel-pattern_rowid').combobox({
			select:
				function (value) {
					var _pattern_rowid = $("#frm_edit #sel-pattern_rowid").val();
					if ((_pattern_rowid > 0) && (_pattern_rowid in _arrPatternDetails)) {
						...
						$("#frm_edit #sel-pattern_rowid").val('');
