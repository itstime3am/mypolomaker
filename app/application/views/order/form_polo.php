...
<?php
	if (!isset($type_premade_order)) {
		echo <<<EOT
								...
								<div class="frm-edit-row-value" style="width:20%;" >
									<select id="sel-polo_pattern_rowid" class="user-input" >
EOT;
...
<script language="javascript">
	...
	$(function() {
		$('#frm_edit #sel-polo_pattern_rowid').combobox({
			select:
				function (value) {
					var _pattern_rowid = $("#frm_edit #sel-polo_pattern_rowid").val();
					if ((_pattern_rowid > 0) && (_pattern_rowid in _arrPatternDetails)) {
						...
						$("#frm_edit #sel-polo_pattern_rowid").val('');
