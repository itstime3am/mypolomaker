...
.size-block div {display:block;float:left;margin:0 0.02cm;text-align:center;line-height:0.5cm;font-size:10px;padding:0px;}
...
.size-block div.cls-size-total {display:block;font-size:16px;height:1.56cm;line-height:3.5;vertical-align:middle;background-color:lightgray;}
...
<?php if (isset($data)) : ?>
			...
			<div class="pdf-row pr-0">
				...
				<div class="pdf-checkbox"><img src="<?php echo ($data['has_sample'] == 1)?'public/images/checkbox_yes.png':'public/images/checkbox_no.png'; ?>"></div><div class="pdf-title w-all" style="margin-left:0;">มีเสื้อตัวอย่าง</div>
			</div>
			<div class="pdf-row">
				<div class="pdf-text-center f-none w-all" style="font-weight:bold;">รายละเอียดเสื้อ</div>
			</div>
