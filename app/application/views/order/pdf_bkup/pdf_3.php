	...
	<?php echo isset($head_section)?$head_section:''; ?>
			...
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border pdf-underline">ชื่อช่างผ่าข้าง</div>
			...
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border pdf-underline">ชื่อช่างลา</div>
					<div class="pdf-tag-border">ผู้ตรวจรับงาน/วันที่</div>
				</div>
				<div class="pdf-tag-detail">
					<div class="pdf-tag-row">
			...
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border pdf-underline">ชื่อช่างโพ้ง</div>
					<div class="pdf-tag-border">ผู้ตรวจรับงาน/วันที่</div>
				</div>
				<div class="pdf-tag-detail">
					<div class="pdf-tag-row">
			...
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border pdf-underline">ชื่อช่างเย็บโปโล</div>
					<div class="pdf-tag-border">ผู้ตรวจรับงาน/วันที่</div>
				</div>
				<div class="pdf-tag-detail">
					<div class="pdf-tag-row">
			...
			<div class="pdf-tag-block">
				<div class="pdf-tag-left">
					<div class="pdf-tag-border pdf-underline">ชื่อช่างต่อ/แล็บ</div>
					<div class="pdf-tag-border">ผู้ตรวจรับงาน/วันที่</div>
				</div>
				<div class="pdf-tag-detail">
					<div class="pdf-tag-row">
