<?php
class Mdl_sleeves_type extends MY_Model {
	function __construct()
	{
		...
		$this->_TABLE_NAME = 'pm_m_sleeves_type';
...
QUERY;
		...
		if (array_key_exists('is_polo', $arrObj)) if (trim($arrObj['is_polo']) != '') $_sql .= "AND COALESCE(t.is_polo, 0) = 1 ";
		if (array_key_exists('is_tshirt', $arrObj)) if (trim($arrObj['is_tshirt']) != '') $_sql .= "AND COALESCE(t.is_tshirt, 0) = 1 ";
