...
class Mdl_flap_side_ptrn extends MY_Model {
	function __construct()
	{
		...
		$this->_TABLE_NAME = 'pm_m_flap_side_ptrn';
	...
	function search($arrObj = array()) {
		$_sql = "SELECT c.*, CASE WHEN is_polo=1 THEN 'Apply' ELSE '' END AS disp_polo, CASE WHEN is_tshirt=1 THEN 'Apply' ELSE '' END AS disp_tshirt FROM " . $this->_TABLE_NAME . " c WHERE True ";
