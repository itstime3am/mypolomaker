...
class Mdl_master_table extends MY_Model { //extens CI_Model
	...
	function list_all_province() {
		...
		$_sql = 'SELECT * FROM pm_m_province ORDER BY name_th'; //real server use "th_TH", local server user "th-TH-x-icu"
...
//echo $this->db->last_query();exit;
	...
	function list_message_notification() {
		...
		/* ++ Inferno::20200714 - PENDING UNTIL FINISH NOTIFY MODULE */
